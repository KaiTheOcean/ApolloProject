 ...
 *      - Most difficult part of the assignment was translating the formulas
 *        into code when, since we are still getting use to the syntax.
 * 5. How long did it take for you to complete the assignment?
 *      - This assignment took approximately an hour to complete between us.
 **************************************************************/


#define _USE_MATH_DEFINES    // Constants from cmath (M_PI)
...
int main()
{
    ...
    accelerationThrust = THRUST / WEIGHT; // Acceleration due to thrust
